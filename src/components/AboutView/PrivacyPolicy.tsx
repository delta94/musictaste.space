...
const PrivacyPolicy = () => {
  ...
  return (
    <>
      <Navbar />
      <Helmet>
        <title>Privacy Policy - musictaste.space</title>
      </Helmet>
      <div className="about">
        <div className="container text-box">
          ...
          <p>
            ...
            insights into their Spotify listening habits and compare their music
            taste with friends.
          </p>
          <p>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to musictaste.space.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to musictaste.space, accessible
                from{' '}
                <a
          ...
          <ul>
            <li>
              <p>Email address associated with your Spotify account</p>
            </li>
            <li>
              <p>Spotify display name</p>
            </li>
            <li>
              <p>Spotify profile image</p>
            </li>
            <li>
              <p>Listening data as provided by the Spotify API</p>
            </li>
            <li>
              <p>Usage data</p>
            </li>
          ...
          <ul>
            ...
            <li>
              <strong>To contact You:</strong> To contact You by email, app
              notification, or other equivalent forms of electronic
          ...
          <p>
            Your information, including Personal Data, is processed at multiple
            secure databases and serverless solutions. This means that this
          ...
          <p>
            Your profile information can be deleted through this web app.{' '}
            <Link to="/account/delete">Click here</Link>.
          </p>
          ...
          <ul>
            <li>By email: musictaste.space@gmail.com</li>
          </ul>
        </div>
      </div>
      <Footer />
